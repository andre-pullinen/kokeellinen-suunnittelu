const threePigs = {
  texts: [
    ...
    [
      'И два храбрых братца пошли гулять. По дороге они пели и плясали, а когда вошли в лес, то так расшумелись, ' +
      'что разбудили волка, который спал под сосной.' +
      '\n',
      '- Что за шум? - недовольно проворчал злой и голодный волк и поскакал к тому месту, откуда доносились ' +
      'визг и хрюканье двух маленьких, глупых поросят.',
      ...
      '\n',
      'И вдруг они увидели настоящего живого волка! Он стоял за большим деревом, и у него был такой страшный вид, ' +
      'такие злые глаза и такая зубастая пасть, что у Ниф-Нифа и Нуф-Нуфа по спинкам пробежал холодок и тонкие ' +
      'хвостики мелко-мелко задрожали. Бедные поросята не могли даже пошевельнуться от страха.',
      'Волк приготовился к прыжку, щелкнул зубами, моргнул правым глазом, но поросята вдруг опомнились и, визжа ' +
      'на весь лес, бросились наутек. Никогда еще не приходилось им так быстро бегать! Сверкая пятками и поднимая ' +
      'тучи пыли, они неслись каждый к своему дому. '
    ], // 04
    [
      ...
      'Волк еще раз глубоко вздохнул и дунул во второй раз: "Ф-ф-ф-у-у-у!". Когда волк дунул в третий раз, ' +
      'дом разлетелся во все стороны, как будто на него налетел ураган. Волк щелкнул зубами перед самым пятачком ' +
      'маленького поросенка, но Ниф-Ниф ловко увернулся и бросился бежать. Через минуту он был уже у двери Нуф-Нуфа.',
      '\n',
      ...
      '\n',
      '- Я передумал! - сказал он так громко, чтобы его услышали в домике. – Я не буду есть этих худосочных поросят!' +
      ' Я пойду домой!',
    ...
    [
      ...
      'Старый волк, страшный волк?',
      '\n',
      'А волк и не думал уходить. Он просто отошел в сторонку и притаился. ' +
      'Он с трудом сдерживал себя, чтобы не расхохотаться.',
      ...
      '- Это я, бедная маленькая овечка! - тонким, чужим голосом пропищал волк. ',
      '- Пустите меня переночевать, я отбилась от стада и очень-очень устала!',
    ...
    [
      ...
      'Братья захлопнули дверь и изо всех сил налегли на нее, чтобы страшный зверь не смог к ним ворваться.',
      '\n',
      ...
      'С крыши слетали листья, стены дрожали, но дом все еще стоял. И, только когда волк дунул в пятый раз, ' +
      'дом зашатался и развалился. Одна только дверь некоторое время еще стояла посреди развалин. ' +
      'В ужасе бросились поросята бежать. От страха у них отнимались ноги, каждая щетинка дрожала, носы пересохли. ' +
      'Братья мчались к дому Наф-Нафа.',
      '\n',
      'Волк нагонял их огромными скачками. Один раз он чуть не схватил Ниф-Нифа за заднюю ножку, но тот вовремя ' +
      'отдернул ее и прибавил ходу.',
      '\n',
      'Волк тоже поднажал. Он был уверен, что на этот раз поросята от него не убегут. Но ему опять не повезло. ' +
      'Поросята быстро промчались мимо большой яблони, даже не задев ее. А волк не успел свернуть и налетел на ' +
      'яблоню, которая осыпала его яблоками. Одно твердое яблоко ударило его между глаз. Большая шишка вскочила ' +
      'у волка на лбу. \n',
      '\n',
      'А Ниф-Ниф и Нуф-Нуф ни живы ни мертвы подбежали в это время к дому Наф-Нафа. Брат впустил их в дом и быстро ' +
      'закрыл дверь на засов. Бедные поросята были так напуганы, что ничего не могли сказать. Они молча бросились ' +
      'под кровать и там притаились. '
    ], // 07
    [
      'Наф-Наф сразу догадался, что за ними гнался волк. Но ему нечего было бояться в своем каменном доме.' +
      ' Он быстро закрыл дверь на засов, сел на табуреточку и запел:',
      '\n',
      'Никакой на свете зверь,',
      ...
      '\n',
      '- Попробуй! - ответил из-за двери Наф-Наф, даже не привстав со своей табуреточки. Он знал, что ему и братьям ' +
      'нечего бояться в прочном каменном доме. Тогда волк втянул в себя побольше воздуха и дунул, как только мог! ' +
      ...
      'Волк стал от злости царапать когтями стены дома и грызть камни, из которых они были сложены,' +
      ' но он только обломал себе когти и испортил зубы. Голодному и злому волку ничего не оставалось делать, ' +
      ...
      '\n',
      'Он осторожно влез на крышу и прислушался. В доме было тихо. Я все-таки закушу сегодня свежей поросятинкой! ' +
      '- подумал волк и, облизнувшись, полез в трубу. '
    ], // 08
    [
      ...
      'Глаза у него вылезли на лоб, вся шерсть поднялась дыбом. С диким ревом ошпаренный волк вылетел ' +
      'обратно на крышу, скатился по ней на землю, перекувырнулся четыре раза через голову, и бросился в лес.',
    ...
    [
      'Он стал спускаться по трубе, но поросята не услышали шорох.',
      'Поросятам не пришлось долго ждать. Черный, как трубочист, волк бултыхнулся прямо в дом. ',
      'Глаза у него были злые, вся шерсть поднялась дыбом. С диким ревом волк набросился на поросят.',
      '\n',
      'А три брата, три маленьких поросенка вжались в угол. Им больше некуда было бежать. Волк их обманул. '
    ], // 10
    [
      'Поросята вот уже несколько дней были заняты постройкой. Они натаскал камней, намесили глины и теперь не спеша ' +
      'строили себе надежный, прочный дом, в котором можно было бы укрыться от ветра, дождя и мороза. Они сделали в ' +
      'доме тяжелую дубовую дверь с засовом, чтобы волк из соседнего леса не мог к нему забраться. '
    ], // 11
    [
      'Но когда поросята приоткрыли дверь, они увидели не овечку, а все того же зубастого волка. ' +
      'Братья попытались захлопнуть дверь и изо всех сил налегли на нее, чтобы страшный зверь не смог к ним ворваться,' +
      ' но волк был намного сильнее и дико голоден.',
      '\n',
      'Волк ворвался в дом поросят и съел их. Сытый и довольный он ушел обратно спать в лес. '
    ], // 12
    [
      'Ниф-Ниф и  Нуф-Нуф строили себе домик. Они старались скорее покончить с этим скучным и неинтересным делом. ' +
      'Они решили, что в соломенном доме зимой будет очень холодно. Дом будет прочнее и теплее, если его построить ' +
      'из веток и тонких прутьев. Так они и сделали. Они вбили в землю колья, переплели их прутьями, на крышу ' +
      'навалили сухих листьев, и к вечеру дом был готов. Нуф-Нуф и Ниф-Ниф с гордостью обошли его ' +
      'несколько раз кругом и запели:',
      '\n',
      'У меня хороший дом,',
      'Новый дом, прочный дом,',
      'Мне не страшен дождь и гром,',
      'Дождь и гром, дождь и гром!',
      '\n',
      '- Ну, вот  дом готов! - сказал Ниф-Ниф брату. - Я говорил, что мы быстро справимся с этим делом! ' +
      'Теперь мы свободны и можем делать все, что нам вздумается!',
      '- Пойдем к Наф-Нафу и посмотрим, какой он себе выстроил дом! – сказал Нуф-Нуф. - Что-то мы его давно не видели!',
      '- Пойдем посмотрим! - согласился Ниф-Ниф. ',
      '\n',
      'Наф-Наф вот уже несколько дней был занят постройкой. Он натаскал камней, намесил глины и теперь не спеша ' +
      'строил себе надежный, прочный дом, в котором можно было бы укрыться от ветра, дождя и мороза. Он сделал ' +
      'в доме тяжелую дубовую дверь с засовом, чтобы волк из соседнего леса не мог к нему забраться.',
      '\n',
      'Ниф-Ниф и Нуф-Нуф застали брата за работой.',
      ' \n',
    ...
    [
      ...
      'По дороге они пели и плясали. До самого вечера они играли на опушке недалеко от своего дома.'
    ] // 15
  ],
  actions: [
    ['Строим общий дом', 'Продолжаем играть'], // 0
    ['Строим вместе', 'Строим по одному'], // 1
    ['Пойти к Наф-нафу'], // 2
    ['Пойдем в лес поиграем!', 'Пойдём на лужайке поиграем!'], // 3
    ['БЕЕЕЖИМ!'], // 4
    ['Фуух, повезло'], // 5
    ['Какая милая овечка!', 'Да это же ВОЛК!'], // 6
    ['Быстрее в дом!'], // 7
    ['Снять крышку', 'А? Что?'], // 8
    [], // 9
    [] // 10
  ],
  currentStep: 0,
